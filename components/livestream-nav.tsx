...
export default function LivestreamNav() {
  ...
  return (
    ...
    {/* Side Navigation - moved outside header to avoid backdrop/transform clipping */}
    <div
      className={`fixed inset-0 bg-black/70 z-[100] lg:hidden transition-opacity duration-300 ${
      ...
      >
        ...
        <nav className="p-4">
          ...
          <div className="mt-6 pt-6 border-t border-gray-800">
            <Link href="/donations" onClick={() => setSideNavOpen(false)}>

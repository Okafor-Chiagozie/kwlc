        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="font-bold text-lg text-white">{details.name || "KWLC"}</h3>
                  <p className="text-xs text-gray-400">KINGDOM WAYS LIVING CHURCH</p>
                </div>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed mb-6">
                {details.welcomeAddress || "Kingdom Ways Living Church is dedicated to spreading God's love and building a community of believers through worship, fellowship, and service."}
              </p>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white">{details.phoneNumber || "+234 70 433 2832"}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-white">{details.email || "info@kwlchq.org"}</p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-8 h-8 rounded-full bg-gray-800 flex items-center justify-center mt-0.5">
                  ...
                  <div>
                    ...
                    <p className="text-white">{details.address || "24 Prince Ibrahim Eletu Avenue, Lagos"}</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-800/50">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-sm text-gray-400">© {new Date().getFullYear()} {details.name || "Kingdom Ways Living Church"}. All rights reserved.</p>
